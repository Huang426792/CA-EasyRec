...
[Paper](paper/Di_Liu_NLP_Assignment.pdf)
...
> Steam, or Yelp results. Fill the paper's pending cells only after completing
> the documented multi-seed experiment.
...
## Official EasyRec experiment

The upstream implementation and data are available at
[HKUDS/EasyRec](https://github.com/HKUDS/EasyRec). The corresponding paper is
[EasyRec: Simple yet Effective Language Models for Recommendation](https://aclanthology.org/2025.emnlp-main.894/),
EMNLP 2025.

Train the six source-domain teachers:
...
Then follow [integration/EASYREC_INTEGRATION.md](integration/EASYREC_INTEGRATION.md)
to pass IDs/domains through the upstream collator and replace only the
contrastive loss block.

The paper protocol uses Sports, Steam, and Yelp for zero-shot all-rank
evaluation, reports Recall@10/20 and NDCG@10/20, and requires five seeds.
...
paper/               ACL-format assignment paper and sources
```
